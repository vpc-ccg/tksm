...
SRC_FILES = tksm.cpp tag.cpp truncate.cpp splicer.cpp single-cell-barcoder.cpp sequencer.cpp polyA.cpp pcr.cpp kde.cpp abundance.cpp strand_man.cpp filter.cpp random_wgs.cpp shuffle.cpp
